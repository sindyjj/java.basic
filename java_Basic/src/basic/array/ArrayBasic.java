...
public class ArrayBasic {
	...
	public static void main(String[] args) {
		...
		//1. 배열 변수의 선언 (데이터 타입 옆에 [] 붙으면 배열이라 생각할 것)
		int[] arr; //java style
		//int arr2[]; //c style

		//2. 배열 객체를 생성 - 실제 값들이 저장할 공간을 형성
		// 생성살 때 배열의 크기를 정해 주셔야 합니다.
		arr = new int[5];
		...
		//6. 배열의 반복문 처리
		//배열은 index 번호 를 제어변수로 활용하여 반복문을 처리할 수 있습니다.
		for(int idx=0;idx<arr.length; idx++) {
			System.out.printf("배열의 %d번째 데이터: %d\n", idx+1, arr[idx]);
		}
		
		//7. 배열 내부의 요소 값을 문자열 형태로 한눈에 출력하기
		...
		String[] names = {"원정욱","원정욱1","원정욱2"};
		System.out.println(Arrays.toString(names));
		
		//names = {"원정욱","원정욱1","원정욱2","원정욱3"}; (x)
		//names = new String[] {"원정욱","원정욱1","원정욱2","원정욱3"}; (o)
