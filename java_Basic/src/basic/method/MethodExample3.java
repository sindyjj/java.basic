...
public class MethodExample3 {
	...
	static double[] calcArrayTotal2(int [] nums) {
		...
		double avg = totals / (double) nums.length;
		return new double [] { totals, avg};
	}
	...
	static void divide(int n1,int n2) {
		if(n2 == 0) {
			System.out.println("너 미쳤어? 0으로 나눌 수 있냐 빙시야?");
			return;
		}
		int result = n1 / n2;
	...
	public static void main(String[] args) {
		...
		int r3 = add(add(4,6),add(7,8)); //int r3 = (4+6) + (7+8) = 25;
        ...
        */
		System.out.println("------------------------------------");
		int sum = calcArrayTotal(57,89,78,91,93,47);
		double sum2 = calcArrayTotal(57,89,78,91,93,47)/6;
        ...
        */
		...
		multi(10,7); // (o)
		// int r4 = multi(10,7); (x) 안됨
		//System.out.println(multi(10,7)); (x) 값이 없어서 나오지 않는다.
		
		multi(add(3,4),add(4,7));//(o)
		//add(multi(4,4),(multi(5,6)); (x) add가 동작을 하지 못한다.
		
		divide(20,0);
		divide(add(12,8),add(1,1));//(o)
