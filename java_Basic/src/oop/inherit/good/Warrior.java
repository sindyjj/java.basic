...
public class Warrior extends Player {   // warrior 워리어를 extends 연장하겠다 Player로
	
	int rage;					
	
		//자동완성 2개
	
		// 방 법 1 ) 자동완성 alt + shift + s --> override/ implement methods 클릭 info 체크 클릭
		
		// 방 법 2 ) 메서드의 이름을 어느정도 알고있다면 cntl + spacebar = overidde method 클릭
		...
		@Override
			void characterInfo() {
				...
				System.out.println(" ");
				System.out.println("한줄 평 : 분노 수급 어려움");
